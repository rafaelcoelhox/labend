...
// Source: github.com/rafaelcoelhox/labbend/internal/core/eventbus (interfaces: EventHandler)
...
func (m *MockEventHandler) HandleEvent(arg0 context.Context, arg1 eventbus.Event) error {
	m.ctrl.T.Helper()
