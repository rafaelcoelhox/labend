...
// Source: github.com/rafaelcoelhox/labbend/pkg/logger (interfaces: Logger)
...
import (
	...
	logger "github.com/rafaelcoelhox/labbend/pkg/logger"
	zap "go.uber.org/zap"
...
func (mr *MockLoggerMockRecorder) GetZapLogger() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZapLogger", reflect.TypeOf((*MockLogger)(nil).GetZapLogger))
}
