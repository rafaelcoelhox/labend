...
// Função helper para conversão segura de uint para string
func uintToStringSafe(value uint) (string, error) {
	if value > math.MaxInt32 {
		return "", errors.New("value too large for safe conversion")
	}
...
func (r *challengeResolver) ID(ctx context.Context, obj *challenges.Challenge) (string, error) {
	return uintToStringSafe(obj.ID)
}
...
func (r *challengeVoteResolver) SubmissionID(ctx context.Context, obj *challenges.ChallengeVote) (string, error) {
	return uintToStringSafe(obj.SubmissionID)
}
