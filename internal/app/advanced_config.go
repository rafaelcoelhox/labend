...
// AdvancedConfig - configuração avançada opcional
...
// LoadAdvancedConfig - carrega configuração avançada
func LoadAdvancedConfig() AdvancedConfig {
	return AdvancedConfig{
		...
		// Database
		DatabaseURL:     getEnv("DATABASE_URL", "postgres://user:password@localhost/challenges?sslmode=disable"),
...
func (c AdvancedConfig) IsProduction() bool {
	return c.Environment == "production"
}

func (c AdvancedConfig) IsDevelopment() bool {
	return c.Environment == "development"
}

func (c AdvancedConfig) GetDatabaseConfig() DatabaseConfig {
